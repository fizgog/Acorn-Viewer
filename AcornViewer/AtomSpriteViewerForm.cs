...
{
    public partial class AtomSpriteViewerForm : Form
    {
        ...
        ///
        /// </summary>
        public AtomSpriteViewerForm()
        {
            InitializeComponent();

            spriteViewer1.StartAddressChanged += new EventHandler(SpriteViewer_StartAddressChanged);
            atomPalette1.ColourChanged += new EventHandler(SpriteViewer_ColourChanged);
        }
        ...
        {
            spriteViewer1.palette = atomPalette1.GetPalette();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            atomPalette1.NumColours = machineList[comboBox1.SelectedIndex].NumColours;
            spriteViewer1.palette = atomPalette1.GetPalette();
